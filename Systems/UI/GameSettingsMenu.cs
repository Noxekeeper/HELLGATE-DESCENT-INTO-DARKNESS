...
internal static class GameSettingsMenu
{
    ...
    public static void ShowSettings()
    {
        ...
        try
        {
            ...
            // Убеждаемся, that Canvas активен
                if (!canvas.activeSelf)
            {
                ...
                // Всегда пересоздаем window for применения изменений
                Plugin.Log?.LogInfo("[GameSettingsMenu] Recreating settings window...");
                ...
                // Убеждаемся, that Canvas активен before показом окна
                    canvas.SetActive(true);
                
                // Убеждаемся, that window активно
                    settingsWindow.SetActive(true);
                
                // Убеждаемся, that window находится поверх other элементов
