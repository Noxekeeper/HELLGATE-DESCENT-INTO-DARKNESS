...
internal class CumDisplayManager
{
    ...
    private static readonly Dictionary<string, string[]> EnemyClipMap = new Dictionary<string, string[]>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        // Goblin -> special clip GoblinsCum2way
        ...
        // SlaveBigAxe -> special clip BigAxe
    ...
    private bool _isPlaying;  // for the first slot (pregnancy)
    private bool _isPlaying2; // for the second slot (VAG/X-ray)
