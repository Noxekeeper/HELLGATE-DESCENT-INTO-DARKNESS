...
internal static class CombatAiConfig
{
    ...
    /// <summary>Max |distance_y| for Dorei to switch to melee; above this keeps crossbow shots.</summary>
    public static float DoreiMeleeMaxVerticalDelta => Get().DoreiMeleeMaxVerticalDelta;
    ...
    public class CombatAiSettings
    {
        ...
        public float DoreiMeleeMaxVerticalDelta = 1.25f;
