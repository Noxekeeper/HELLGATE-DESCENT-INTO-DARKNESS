...
// Colors are now taken from config
    ...
    /// Animations for TouzokuAxe: START, START2, START3, START4, START5, ERO, ERO2, 2ERO, 2ERO2, 2ERO3, 2ERO4, FIN, FIN2, FIN3, JIGO, JIGO2
    /// </summary>
    private static void ParseAnimationComments(string jsonText)
    {
        try
        {
            ...
            // Animation list for parsing (matches EroTouzokuAXE.cs)
            string[] animations = { 
...
// Debug logging disabled
        ...
        // Set verticalOffset based on animation phase
    ...
    private static void LoadAradiaData()
    {
        try
        {
            ...
            // Parse animations section for dialogues
...
// ColorParser is used for color parsing
    ...
    /// <summary>
    /// Parse dialogues for a specific animation
    /// </summary>
    ...
    /// <summary>
    /// Parse mindBroken levels for events
    /// </summary>
            ...
            foreach (string level in levels)
            {
                ...
                if (levelMatch.Success)
                {
                    ...
                    if (levelEnd > levelStart)
                    {
                        ...
                        {
                            // Add into the matching structure
    ...
    /// <summary>
    /// Start coroutine to schedule PC reply
    /// </summary>
