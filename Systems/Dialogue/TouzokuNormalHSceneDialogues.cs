...
/// <summary>
/// TouzokuNormal dirty phrases system during H-scenes
/// Bound to specific animations and events
/// </summary>
internal static class TouzokuNormalHSceneDialogues
{
    ...
    private static float _verticalOffset = 50.0f;
    ...
    /// </summary>
    private static void LoadTouzokuHSceneData()
    {
...
// Colors are now taken from config
    ...
    private static void ParseAnimationComments(string jsonText)
    {
        try
        {
            ...
            // List of animations for parsing (including all with underscore)
            string[] animations = { 
                "START", "START2", "START3", 
            ...
            foreach (string animName in animations)
            {
                ...
                // Find section for this animation
    ...
    private static void ParseEventsForAnimation(string animBlock, Dictionary<string, List<string>> eventComments)
    {
        ...
        // Parse events: SE, SE1, SE2, SE3, SE8, START, START2, START3, ERO, ERO1, etc.
        // Include all animation switch events (including underscored names)
        // FIN_pre — special event for the moment before FIN starts (count == 1)
        string[] eventNames = { 
            "SE", "SE1", "SE2", "SE3", "SE8",
            "START", "START2", "START3",
            "ERO", "ERO1", "ERO2", "ERO3", "ERO4", "ERO5",
            "2ERO", "2ERO2",
            "FIN", "FIN2", "FIN_pre", // FIN_pre - for moment before start of FIN (count == 1)
            "JIGO", "JIGO2",
            "_2ERO2", "_2ERO3", "_2ERO4", "_2ERO6", "_2ERO7",
            "_ERO5", "_ERO7", "_ERO8", "_ERO9", "_ERO10", "_ERO11", "_ERO12",
            "_FIN3",
    ...
    /// <summary>
    /// Process H-scene events TouzokuNormal
    /// Returns true if phrase was shown, false if not
    /// </summary>
    internal static bool ProcessHSceneEvent(object enemyInstance, string animationName, string eventName, int seCount)
    {
