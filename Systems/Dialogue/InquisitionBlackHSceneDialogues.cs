...
// Debug logging disabled
    ...
    /// Animations for InquisitionBlack: START, START2, ERO, ERO1, ERO2, ERO3, ERO4, FIN, FIN2, JIGO, JIGO2, JIGOFIN, JIGOFIN2
    /// </summary>
    private static void ParseAnimationComments(string jsonText)
    {
        try
        {
            ...
            // Animation list for parsing (matches InquiBlackEro.cs)
            string[] animations = { 
                "START", "START2",
    ...
    /// <summary>
    /// Parse color from JSON settings
    /// </summary>
