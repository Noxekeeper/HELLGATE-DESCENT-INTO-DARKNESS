...
internal class DialogueDatabase
{
            ...
            if (animStart >= 0)
            {
                ...
                if (braceStart >= 0)
                {
                    ...
                    if (braceEnd > braceStart)
                    {
                        ...
                        // Find segments (se_count_X_segments or any_segments)
                        ...
                        foreach (Match segmentMatch in segmentMatches)
                        {
                            ...
                            // Parse each segment "1": ["item1", "item2"]
    ...
    /// <summary>
    /// Load default data if JSON is missing
    /// </summary>
    ...
    /// <summary>
    /// Get Mutude-specific onomatopoeia for animation and se_count
    /// </summary>
    ...
    /// <summary>
    /// Get onomatopoeia by segment for animation and se_count
    /// </summary>
    ...
    /// <summary>
    /// Check whether segments exist for animation and se_count
    /// </summary>
    ...
    /// <summary>
    /// Get segment count for animation and se_count
    /// </summary>
