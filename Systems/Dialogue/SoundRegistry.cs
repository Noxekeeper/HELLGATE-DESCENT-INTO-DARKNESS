...
internal class SoundRegistry
{
    ...
    private static void ParseSoundMapping(string json)
    {
        try
        {
            ...
            // Improved parsing: find each "soundName": [array] pair
            // Use a more reliable pattern that handles multiline arrays and nested braces
            // Pattern: "soundName": [... ] where... may contain line breaks
            string pattern = @"\""([^\""]+)\""\s*:\s*\[(.*?)\]";
            ...
            foreach (Match soundMatch in soundMatches)
            {
                ...
                // Parse array elements — find all quoted strings
    ...
    /// <summary>
    /// Register sounds (callable manually or via intercept)
    /// </summary>
    ...
    /// <summary>
    /// Get onomatopoeia by sound name
    /// </summary>
    ...
    /// <summary>
    /// Check whether a registration exists for the sound
    /// </summary>
    ...
    /// <summary>
    /// Get a random onomatopoeia for the sound
    /// </summary>
