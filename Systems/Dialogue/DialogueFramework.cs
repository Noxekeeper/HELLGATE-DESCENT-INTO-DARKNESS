...
internal static class DialogueFramework
{
    ...
    internal static void Initialize()
    {
        ...
        // Initialize biscord branch dialogues (JSON-driven).
        BiscordDialogues.Initialize();
    ...
    /// <summary>
    /// Hide all visible dialogue bubbles immediately (H-scene escape / overlay cleanup).
    /// </summary>
    internal static void DismissAllVisible()
    {
        if (!_initialized || _display == null)
            return;

        _display.DismissAllVisible();
    }
