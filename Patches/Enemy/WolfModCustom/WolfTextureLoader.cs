...
/// <summary>
/// TextureLoader for Spine Atlas — loads PNG from disk, creates a Material, assigns page.rendererObject.
/// Avoids needing TextAsset (Unity 5.6 cannot create them via reflection).
/// </summary>
