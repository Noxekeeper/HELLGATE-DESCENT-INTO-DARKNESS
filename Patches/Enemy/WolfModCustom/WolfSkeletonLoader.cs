...
/// <summary>
/// Loads Wolf Spine assets (WolfE for combat, Wolf for H-scenes) from the resource folder
/// via the direct Spine API, bypassing TextAsset (incompatible with Unity 5.6).
/// </summary>
internal static class WolfSkeletonLoader
{
    ...
    /// <summary>
    /// Holds preloaded SkeletonData and AnimationStateData for custom assets.
    /// The Harmony patch returns these instead of calling the original GetSkeletonData/GetAnimationStateData.
    /// </summary>
    ...
    /// <summary>
    /// Load via the Spine API (Atlas + SkeletonJson) without TextAsset.
    /// </summary>
    private static SkeletonDataAsset LoadViaSpineApi(string jsonPath, string atlasPath, string pngPath, string name, GameObject materialTemplate)
    {
        ...
        try
        {
            ...
            atlas.FlipV(); // Critical for Unity: Spine atlas uses inverted V UVs; without FlipV sprites look scrambled
...
/// <summary>
/// Harmony patch for SkeletonDataAsset.GetSkeletonData and GetAnimationStateData.
/// Returns preloaded data for Wolf assets to work around a missing skeletonJSON.
/// </summary>
