...
/// <summary>
/// Patch for LibrarianERO — handoff of GG after 1 cycle (on JIGO2)
/// </summary>
class LibrarianPassPatch : BaseEnemyPassPatch<LibrarianERO>
{
    ...
    {
        // Handoff on the JIGO event (transition to JIGO animation)
        // Do not fire on JIGO2 or on SE events inside the JIGO animation
    ...
    {
        // 50/50 chance to start from START3 or ERO
