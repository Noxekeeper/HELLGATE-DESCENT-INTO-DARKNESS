...
/// <summary>
/// TextureLoader for Spine Atlas — loads PNG from disk for DoreiFapping skeleton.
/// </summary>
internal sealed class DoreiTextureLoader : TextureLoader
{
    private readonly string _imagesDir;
    private readonly Material _materialTemplate;
    private readonly string _name;

    public DoreiTextureLoader(string imagesDir, Material materialTemplate, string name)
    {
        _imagesDir = imagesDir ?? "";
        _materialTemplate = materialTemplate;
        _name = name ?? "DoreiFapping";
    }
    ...
    public void Load(AtlasPage page, string path)
    {
        ...
        {
            Plugin.Log?.LogError($"[DoreiTextureLoader] PNG not found: {fullPath}");
            return;
        }
        ...
        {
            Plugin.Log?.LogError($"[DoreiTextureLoader] Failed to load image: {fullPath}");
            return;
        }
