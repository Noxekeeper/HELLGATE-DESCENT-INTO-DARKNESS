...
class DoreiPassLogic : BaseEnemyPassPatch<SinnerslaveCrossbowERO>
{
    ...
    private static void ClearStateOnImmediatelyERO()
    {
        try
        {
            // Verify the current enemy is Dorei
    ...
    private static void PushPlayerAwayFromEnemy(object enemyInstance)
    {
        ...
        try
        {
            ...
            if (doreiero != null)
            {
                // Get parent (SinnerslaveCrossbow) and reset its state
                ...
                if (ownerField != null)
                {
                    ...
                    if (owner != null)
                    {
                        try
                        {
                            ...
                            // Copy the private eroflag and clear it
                ...
                // Reset the flag on the animation itself
            ...
            // Disable the enemy's current animation
