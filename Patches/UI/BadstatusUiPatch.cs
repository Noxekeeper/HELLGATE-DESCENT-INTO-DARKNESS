        ...
        try
        {
            ...
            if (BarField?.GetValue(__instance) is Image bar && bar != null)
            {
                ...
                if (barRect != null)
                {
                    ...
                    barRect.anchorMax = new Vector2(1f, 0.5f); // Stretch to parent width
                    barRect.pivot = new Vector2(0.5f, 0.5f);
                    // Inner padding within the frame
    ...
    private static void AdjustText(Badstatus instance)
    {
        try
        {
            if (TextField?.GetValue(instance) is TextMeshProUGUI tmp && tmp != null)
            {
                ...
                // Reduce font size by 1 for Climax, pregnancy, and pleasure
                ...
                if (textRect != null)
                {
                    ...
                    // Text to the right of the bars (already positioned via LabelOffset)
