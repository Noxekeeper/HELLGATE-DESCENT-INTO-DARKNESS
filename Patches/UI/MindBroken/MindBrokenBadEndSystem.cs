...
internal static class MindBrokenBadEndSystem
{
    ...
    private static void EnsureBadEndPlayerLoseScreen()
    {
        ...
        youLoseTxt.font = NoREroMod.Systems.UI.HellGateFontProvider.GetUiFont();
        ...
        epilogueTxt.font = NoREroMod.Systems.UI.HellGateFontProvider.GetUiFont();
        ...
        clickTxt.font = NoREroMod.Systems.UI.HellGateFontProvider.GetUiFont();
    ...
    internal static void HideBadEnd()
    {
        ...
        if (_coroutineRunner is BadEndRunner runner)
            runner.StopAllCoroutines();
    ...
    private static void CreateBadEndUI()
    {
        ...
        _epilogueLabel.font = NoREroMod.Systems.UI.HellGateFontProvider.GetUiFont(); // As in Corruption system
        ...
        buttonText.font = NoREroMod.Systems.UI.HellGateFontProvider.GetUiFont();
